        ...
        <div className="w-full h-full bg-gradient-to-r form-primary/10 via-black/30 to-black/10">
          <div className="text-right justify-end xl:pt-40 xl:text-right h-full container flex flex-col justify-center lg:justify-start  lg:absolute lg:left-0">
            ...
            <motion.p
              ...
              exit="hidden"
            >
              شما می توانید انواع ایده های خود را با ما در میان بگذارید ما در
              تلاش هستیم سایت های تعاملی بیشتری را توسعه بدهیم ما با استفاده از
              تکنولوژی های قدرتمند مفتخریم مدعی این باشیم که سایت شما را با توجه
              به نوع کسب و کارتان با ان هوش مصنوعی مختص به خود را بدهیم در صورت
              نیاز می توانید با ما در ارتباط باشید
            </motion.p>
            {/* btn */}
